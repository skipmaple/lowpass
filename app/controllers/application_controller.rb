class ApplicationController < ActionController::Base
  ...
  inertia_share do
    {
      latest_weekly_key: (Issue.latest_weekly_key if Current.user),
      ...
      flash: { notice: flash[:notice], alert: flash[:alert], id: (request.uuid if flash[:notice] || flash[:alert]) }.compact
    }
  end
