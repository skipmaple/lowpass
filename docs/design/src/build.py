...
canvas = {
    ...
    'artboards': [
        ...
        {'file': 'MinBento.dc.html', 'x': 0, 'y': 2000, 'w': 1440, 'h': H, 'title': '方向 4 · 便当格', 'page': P1},
        {'file': 'MinRail.dc.html', 'x': 1560, 'y': 2000, 'w': 1440, 'h': H, 'title': '方向 5 · 早间轴', 'page': P1},
        {'file': 'MinJournal.dc.html', 'x': 3120, 'y': 2000, 'w': 1440, 'h': H, 'title': '方向 6 · 手账', 'page': P1},
    ...
    'annotations': [
        ...
        {'id': 'm4', 'x': 0, 'y': 1760, 'w': 560, 'page': P1, 'text': '方向 4 · 便当格\n主意：不等宽的拼盘。日期格、"67 条"数字格、周刊格与三个来源格，圆角 20，只用两种底色。\n取舍：一屏全览、有节奏；格子多了要靠字号压秩序。'},
        {'id': 'm5', 'x': 1560, 'y': 1760, 'w': 560, 'page': P1, 'text': '方向 5 · 早间轴\n主意：把一期当作一段时间。居中单栏，左侧一条轴从"06:12 装订"到"明早 06:00 下一期"，太阳点是唯一的渐变。\n取舍：叙事感强、最像"早读"；单栏纵向长，一屏看不全。'},
        {'id': 'm6', 'x': 3120, 'y': 1760, 'w': 560, 'page': P1, 'text': '方向 6 · 手账\n主意：一页笔记。文楷同时用于日期与板块名，点线分隔像横格纸，元数据放到右侧页边像批注，杏橙圆点做项目符号。\n取舍：最有温度、最个人；文楷用量超出"只做期头"的原定范围。'},
        {'id': 'keep-note', 'x': 3120, 'y': 3800, 'w': 560, 'page': P1, 'text': '六稿统一：白底，唯一点缀色杏橙 #F26B3A（文字用深一档 #B8461C），Instrument Sans 配 Noto Sans SC，元数据 Maple Mono，期头文楷。这样比的是版面结构。Main 当前是方向 1。'},
