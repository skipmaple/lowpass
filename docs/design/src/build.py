...
pages = {
    ...
    'FrontIssueStates.dc.html': G.front3_issue_states(), 'FrontMenu.dc.html': G.front3_menu(), 'FrontErrors.dc.html': G.front3_errors(),
    ...
    'SiteWeeklyStates.dc.html': S.weekly_states(), 'SiteAdminRuns.dc.html': S.admin_runs(), 'SiteAdminDialogs.dc.html': S.admin_dialogs(), 'SiteAdminSourceForms.dc.html': S.admin_source_forms(),
    # 第八轮：头条放大分两栏（已否，存档）
...
canvas = {
    ...
    'artboards': [
        ...
        {'file': 'FrontIssueStates.dc.html', 'x': 4680, 'y': 1100, 'w': 1440, 'h': 4200, 'title': '日刊 · 期级状态：生成中、空刊、缺期、昨日、已修订', 'page': P1},
        {'file': 'FrontMenu.dc.html', 'x': 6800, 'y': 0, 'w': 1440, 'h': 800, 'title': '头像菜单 · admin 与成员', 'page': P1},
        {'file': 'FrontErrors.dc.html', 'x': 6800, 'y': 1000, 'w': 1440, 'h': 1100, 'title': '错误页 403 / 404 / 500', 'page': P1},
        {'file': 'SiteWeekly.dc.html', 'x': 0, 'y': 0, 'w': 1440, 'h': 2500, 'title': '周刊详情', 'page': P8},
        {'file': 'SiteWeeklyMobile.dc.html', 'x': 1560, 'y': 0, 'w': 390, 'h': 2900, 'title': '周刊详情 · 手机', 'page': P8},
        ...
        {'file': 'SiteSearchStates.dc.html', 'x': 1560, 'y': 3200, 'w': 1440, 'h': 2900, 'title': '搜索 · 未搜索、无结果、限流、不可用', 'page': P8},
        {'file': 'SiteLogin.dc.html', 'x': 3120, 'y': 3200, 'w': 1440, 'h': 1500, 'title': '登录 · 默认、已取消、失败、无法合并', 'page': P8},
        {'file': 'SiteSettings.dc.html', 'x': 4680, 'y': 3200, 'w': 1440, 'h': 1000, 'title': '设置', 'page': P8},
        {'file': 'SiteAdminSources.dc.html', 'x': 0, 'y': 6300, 'w': 1440, 'h': 900, 'title': '管理后台 · 信息源', 'page': P8},
        {'file': 'SiteAdminSourceForm.dc.html', 'x': 1560, 'y': 6300, 'w': 1440, 'h': 1500, 'title': '管理后台 · 新建来源与测试抓取', 'page': P8},
        {'file': 'SiteAdminIssues.dc.html', 'x': 3120, 'y': 6300, 'w': 1440, 'h': 1000, 'title': '管理后台 · 期', 'page': P8},
        {'file': 'SiteAdminUsers.dc.html', 'x': 4680, 'y': 6300, 'w': 1440, 'h': 800, 'title': '管理后台 · 用户', 'page': P8},
        {'file': 'SiteAdminSettings.dc.html', 'x': 6240, 'y': 6300, 'w': 1440, 'h': 1900, 'title': '管理后台 · 设置', 'page': P8},
        {'file': 'SiteWeeklyStates.dc.html', 'x': 0, 'y': 8400, 'w': 1440, 'h': 1300, 'title': '周刊 · 降级源节与通用 RSS 源节', 'page': P8},
        {'file': 'SiteAdminRuns.dc.html', 'x': 1560, 'y': 8400, 'w': 1440, 'h': 1300, 'title': '管理后台 · 抓取记录', 'page': P8},
        {'file': 'SiteAdminDialogs.dc.html', 'x': 3120, 'y': 8400, 'w': 1440, 'h': 1900, 'title': '管理后台 · 确认对话框与操作反馈', 'page': P8},
        {'file': 'SiteAdminSourceForms.dc.html', 'x': 4680, 'y': 8400, 'w': 1440, 'h': 1900, 'title': '管理后台 · 其他适配器表单与测试失败', 'page': P8},
