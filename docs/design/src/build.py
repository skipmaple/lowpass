...
canvas = {
    ...
    'artboards': [
        {'file': 'TerracottaDaily.dc.html', 'x': 0, 'y': 0, 'w': 1440, 'h': 1300, 'title': '方向 1 · Terracotta', 'page': P1},
        {'file': 'RisoDaily.dc.html', 'x': 1560, 'y': 0, 'w': 1440, 'h': 1300, 'title': '方向 2 · Riso', 'page': P1},
        {'file': 'ClaudeWarmDaily.dc.html', 'x': 3120, 'y': 0, 'w': 1440, 'h': 1300, 'title': '方向 3 · Claude 暖编辑', 'page': P1},
        {'file': 'Main.dc.html', 'x': 0, 'y': 1460, 'w': 1440, 'h': 1300, 'title': 'Main · 领先候选（同 Terracotta）', 'page': P1},
    ...
    'annotations': [
        ...
        {'id': 'keep-note', 'x': 1560, 'y': 1460, 'w': 560, 'page': P1,
