...
canvas = {
    ...
    'artboards': [
        ...
        {'file': 'Home.dc.html', 'x': 1560, 'y': 0, 'w': 1440, 'h': 1120, 'title': '首页', 'page': 'page-1'},
        ...
        {'file': 'Weekly.dc.html', 'x': 2120, 'y': 1400, 'w': 1440, 'h': 1500, 'title': '周刊详情', 'page': 'page-1'},
        {'file': 'WeeklyMobile.dc.html', 'x': 0, 'y': 3060, 'w': 390, 'h': 1160, 'title': '周刊详情 · 手机', 'page': 'page-1'},
        {'file': 'WeeklyArchive.dc.html', 'x': 560, 'y': 3060, 'w': 1440, 'h': 900, 'title': '周刊归档', 'page': 'page-1'},
        {'file': 'Search.dc.html', 'x': 2120, 'y': 3060, 'w': 1440, 'h': 1200, 'title': '搜索', 'page': 'page-1'},
        {'file': 'Settings.dc.html', 'x': 0, 'y': 4400, 'w': 1440, 'h': 760, 'title': '设置', 'page': 'page-1'},
        {'file': 'Components.dc.html', 'x': 0, 'y': 0, 'w': 1440, 'h': 2200, 'title': '组件与规范', 'page': 'page-2'},
