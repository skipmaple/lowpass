...
canvas = {
    ...
    'artboards': [
        {'file': 'Main.dc.html', 'x': 0, 'y': 0, 'w': 1440, 'h': 2200, 'title': '日刊 · Hacker News 书脊（Main）', 'page': P1},
        {'file': 'FrontGitHub.dc.html', 'x': 1560, 'y': 0, 'w': 1440, 'h': 2400, 'title': '日刊 · GitHub Trending 书脊', 'page': P1},
        {'file': 'FrontHackaday.dc.html', 'x': 3120, 'y': 0, 'w': 1440, 'h': 2400, 'title': '日刊 · Hackaday 书脊', 'page': P1},
